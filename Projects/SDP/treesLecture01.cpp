...
{	
  ...
  bot.insertBOT(56)
	...
	calc.add('+',"").add('*',"L").add('+',"R").add('2',"LL").add('3',"LR").add('14',"RL").add('0',"RR");
	cout<<calc.calculateTree()<<endl;
	...
	//tree.serializeScheme(cout);

   // BTree<int> demo = bot.insertedBOT(61);
	//demo.prettyPrint();

	//tree.simplePrint();

	//BTree<int> test = tree; // copy constructor
	//test.prettyPrint();

    //cout<<bot.minElement()<<endl;
    ...
    //cout<<"Not leaves: "<<tree.notLeaves()<<endl;
